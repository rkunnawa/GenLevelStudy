...
#process.qcdCombBKGStudy_QQ = process.qcdAna.clone(
#  doFlavor = cms.bool(True),
#  doCombBKGStudy = cms.bool(True),
#  flavorID = qg,
#  flavorID_LeadJet = quarks,
#  flavorID_SubLeadJet = quarks,
#  combBKG_RMS = cms.double(2.50)
#)

#process.qcdCombBKGStudy_GG = process.qcdAna.clone(
#  doFlavor = cms.bool(True),
#  doCombBKGStudy = cms.bool(True),
#  flavorID = qg,
#  flavorID_LeadJet = gluons,
#  flavorID_SubLeadJet = gluons,
#  combBKG_RMS = cms.double(2.50)
#)

#process.qcdCombBKGStudy_QG = process.qcdAna.clone(
#  doFlavor = cms.bool(True),
#  doCombBKGStudy = cms.bool(True),
#  flavorID = qg,
#  flavorID_LeadJet = quarks,
...
#process.qcdCombBKGStudy_GQ = process.qcdAna.clone(
#  doFlavor = cms.bool(True),
#  doCombBKGStudy = cms.bool(True),
#  flavorID = qg,
#  flavorID_LeadJet = gluons,
...
process.ana_step = cms.Path(
  process.qcdAna 
#  process.qcdCombBKGStudy_QQ
#  process.qcdCombBKGStudy_GG *
#  process.qcdCombBKGStudy_QG *
#  process.qcdCombBKGStudy_GQ 
